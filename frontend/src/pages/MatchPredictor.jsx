  ...
  return (
    <div className="prob-bar-wrap">
      <div className="prob-labels">
        <span className="prob-label-team text-cyan">{labelA}</span>
        <span className="prob-label-draw text-muted">Draw</span>
        <span className="prob-label-team text-pink">{labelB}</span>
      </div>
      ...
      <div className="prob-vals">
        <span className="text-cyan bold">{pA}%</span>
        <span className="text-muted">{pD}%</span>
        <span className="text-pink bold">{pB}%</span>
      </div>
    </div>
  );
}
    ...
    <div className="penalty-block">
      ...
      <div className="penalty-bars">
        <div className="penalty-bar-row">
          ...
          <span className="penalty-pct text-cyan">{Math.round(cfA * 100)}%</span>
        </div>
        <div className="penalty-bar-row">
          ...
          <span className="penalty-pct text-pink">{Math.round(cfB * 100)}%</span>
        </div>
      </div>
    </div>
  );
    ...
    <main className="predictor-page page">
      <div className="page-header">
        <div className="container">
          ...
          <h1 className="display-lg center">Match Predictor</h1>
            ...
            <div className="team-selector-block card-elevated">
              ...
              {teamA && teamB && teamA !== teamB && (
                <div className="vs-display animate-in">
                  <span className="vs-team text-cyan">{teamA}</span>
                  <span className="vs-divider">vs</span>
                  <span className="vs-team text-pink">{teamB}</span>
                </div>
              )}
            </div>
              ...
              <div className="whatif-adjustments animate-in mt-16">
                ...
                <div className="adj-panels">
                  <div className="adj-panel card">
                    <span className="label text-cyan mb-12">{teamA || 'Team A'}</span>
                  ...
                  <div className="adj-panel card">
                    <span className="label text-pink mb-12">{teamB || 'Team B'}</span>
                ...
                <div className="result-header card-elevated">
                  <div className="result-teams">
                    <div className="result-team-block">
                      <span className="result-team-name text-cyan">{result.team_a}</span>
                    ...
                    <div className="result-team-block result-team-block--right">
                      <span className="result-team-name text-pink">{result.team_b}</span>
